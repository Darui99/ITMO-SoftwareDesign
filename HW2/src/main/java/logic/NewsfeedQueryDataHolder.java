...
public class NewsfeedQueryDataHolder {
    ...
    public String buildQuery() {
        ...
        builder.setParameter("q", hashtag);
        builder.setParameter("count", "0");
        builder.setParameter("start_time", String.valueOf(startTime));
        builder.setParameter("end_time", String.valueOf(endTime));
        try {
            return builder.build().toURL().toString();
        } catch (MalformedURLException | URISyntaxException e) {
            throw new RuntimeException("Error while building URL: " + e.getMessage(), e);
        }
    }
